...
void ShadowMapApp::LoadTextures()
{
    ...
    {
        L"artRes/Textures/bricks2.dds",
        L"artRes/Textures/bricks2_nmap.dds",
        L"artRes/Textures/tile.dds",
        L"artRes/Textures/tile_nmap.dds",
        L"artRes/Textures/white1x1.dds",
        L"artRes/Textures/default_nmap.dds",
        L"artRes/Textures/desertcube1024.dds"
    };
...
{
    std::ifstream fin("artRes/models/skull.txt");

    if (!fin)
    {
        MessageBox(0, L"artRes/models/skull.txt not found.", 0, 0);
        return;
    }
