...
{
	mShaders["standardVS"] = d3dUtil::CompileShader(L"src\\shaders\\color.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"src\\shaders\\color.hlsl", nullptr, "PS", "ps_5_0");
